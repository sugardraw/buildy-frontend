				...
				<ScrollView ref="scrollView">
					...
					>
								...
								this.state.professional.map((professional, i) => (
									...
									>
										...
										<View style={styles.paragraphText}>
											...
											<Text style={styles.infoText}>{professional.street}</Text>
						...
						<View style={styles.geo}>
							<Text style={[ styles.servicesList, { fontSize: 20, marginBottom: 20, marginLeft: 20 } ]}>
								Location
							</Text>

							{this.state.lat !== '' && <Geo lon={this.state.lon} lat={this.state.lat} />}
						</View>
